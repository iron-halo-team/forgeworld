...
Официальный офлайн-лаунчер Forge World для одной заранее подготовленной сборки Minecraft: **NeoForge 1.21.1**. Игрок скачивает лаунчер, вводит ник, нажимает **Играть** и запускает уже упакованный клиент без ручной установки Forge, модов, конфигов или отдельной Java.

Лаунчер задуман как витрина сервера: новости, история мира, ссылки на Discord/Wiki/GitHub, проверка онлайна и уведомление о новой версии обновляются владельцем проекта вручную вместе с новым релизом.
...
- Кастомные PNG-ассеты, ICO-иконка приложения и пиксельные шрифты.
